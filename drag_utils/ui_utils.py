...
from drag_utils.utils import import_model_class_from_model_name_or_path
...
class LightningDragUI:
    ...
    def __init_model(
        ...
        if lcm_lora_path is not None:
            ...
            ## added lines
            # lora_path = os.path.abspath("./test.safetensors")
            # print("using lora: {}".format(lora_path))
            # self.pipe.load_lora_weights(lora_path, weight_name="test.safetensors")
            ##
            self.pipe.fuse_lora()
